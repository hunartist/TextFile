...
<%--                <asp:TemplateField HeaderText ="教室edit">
                    <ItemTemplate>
                        <asp:DropDownList ID ="ddlRoom" runat ="server" DataSourceID="SqlDataSourceRoom" DataTextField="strRoomName" DataValueField="strRoomName" AppendDataBoundItems="True" AutoPostBack="False"></asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>--%>
